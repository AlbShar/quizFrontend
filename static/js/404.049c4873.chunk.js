"use strict";(globalThis.webpackChunkquizfrontend=globalThis.webpackChunkquizfrontend||[]).push([[404],{6155:(e,t,n)=>{n.d(t,{Z:()=>h});var i=n(2791),r=n(6983),s=n(7691);const o=s.ZP.article`
  cursor: pointer;
  position: relative;
  height: 100%;
  width: 100%;
...
`;var f=n(184);const h=e=>{let{data:t,selected:n,customStyle:s,onClickElement:h,srcImg:m="",srcArrowDown:g}=e;const[w,b]=(0,i.useState)(!1),j=()=>{b((e=>!e))},v=(e=>Array.isArray(e)?e.map(((e,t)=>(0,f.jsx)(u,{tabIndex:0,onClick:()=>{h&&h(e),j()},children:(0,f.jsx)("div",{style:{display:"inline-flex",alignItems:"baseline",gap:2,justifyContent:"center"},children:(0,f.jsx)(d,{children:e})})},t+1))):Object.entries(e).map(((e,t)=>{const n=e[1],i=e[0];return(0,f.jsx)(u,{tabIndex:0,onClick:()=>{h&&h(n),j()},children:(0,f.jsxs)("div",{style:{display:"inline-flex",alignItems:"baseline",gap:2,justifyContent:"center"},children:[(0,f.jsx)("span",{style:{fontSize:16,fontWeight:600},children:n.toUpperCase()}),(0,f.jsx)("span",{style:{fontSize:12,fontWeight:400},children:i})]})},t+1)})))(t);return(0,i.useEffect)((()=>{const e=e=>{const t=e.target;t.closest("ul")||t.closest("button")||b(!1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[]),(0,f.jsxs)(o,{children:[(0,f.jsxs)(a,{onClick:()=>{j()},children:[m?(0,f.jsx)(c,{src:m,alt:"img"}):null,(0,f.jsx)(l,{className:"dropdown-btn-text",customStyle:s||"",children:n.toUpperCase()||""}),(0,f.jsx)(x,{src:g,alt:"\u041a\u043d\u043e\u043f\u043a\u0430 \u0432\u043d\u0438\u0437"})]}),(0,f.jsx)(r.Z,{in:w,timeout:300,classNames:"list",children:(0,f.jsx)(f.Fragment,{children:w&&(0,f.jsx)(p,{children:v})})})]})}},124:(e,t,n)=>{n.d(t,{Z:()=>l});var i=n(9388),r=n(7691);const s=r.ZP.span`
  color: red;
  display: inline-block;
  margin: 0 5px 0 0 ;
...
`,Y=d.ZP.h2`
  ...
  margin: 0;
  padding: 0;
`,V=e=>{let{setRightAnswers:t}=e;const{t:n}=(0,s.$)(),[r]=(0,i.useContext)(y.iT),[o]=(0,i.useContext)(y.Hp),[a,l]=(0,i.useState)(!0),[d,c]=(0,i.useState)(!1),[p,u]=(0,i.useState)(0),[f,h]=(0,i.useState)(0),m=e=>{const n={points:null,totalQuestionNumbers:0},[i,r]=e;n.points=(e=>{if(e)return Object.fromEntries(Object.entries({...e}).map((e=>{let[t,n]=e;return[t,n.point]})));return null})(r.value),n.totalQuestionNumbers=i.value?i.value:!1!==i.value&&null,l(!1),h(M(n.points)),u(n.totalQuestionNumbers),t(M(n.points));for(const t in n)if(null===n[t])throw new Error(`The value of ${t} is ${n[t]} in ${n}`)},g=e=>{throw c(!0),l(!1),new Error(e)};(0,i.useEffect)((()=>{const e=`${o}/questions`,t=`${o}/users/user${r}/answers`;Promise.allSettled([(0,Q.r)(e),W(t)]).then(m).catch(g)}),[]);const w=!!a&&(0,x.jsx)(j.Z,{width:50,height:50,color:"#1f2ce0",margin:"0 auto"}),b=!!d&&(0,x.jsx)(k.Z,{}),v=!a&&!d&&(0,x.jsxs)(K,{children:[(0,x.jsx)(U,{children:n("\u0412\u0430\u0448_\u0440\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442")}),(0,x.jsx)(Y,{children:`${f} ${n("\u0438\u0437")} ${p}`})]});return(0,x.jsxs)(x.Fragment,{children:[w," ",b," ",v]})},X=d.ZP.article`
  text-align: center;
  padding: 16px 0;
...
`,J=d.ZP.h2`
  ...
  margin: 0;
  padding: 0;
`,ee=(e,t,n)=>{let i="";if("number"===typeof e){if(e%60===0)i=`${e/60} ${t}`;else if(e<60)i=`${e}  ${t}`;else if(e>60){const r=Math.floor(e/60);i=`${r}  ${n} ${e-60*r}  ${t}`}return i}return"boolean"!==typeof e&&null},te=()=>{const{t:e}=(0,s.$)(),[t]=(0,i.useContext)(y.iT),[n,r]=(0,i.useState)({loading:!0,error:!1,time:0}),[o,a]=(0,i.useState)(!0),[l,d]=(0,i.useState)(0),[c,p]=(0,i.useState)(!1),[u]=(0,i.useContext)(y.Hp),h=e=>{const{time:t}=e;a(!1),d(t)},g=!!o&&(0,x.jsx)(j.Z,{width:50,height:50,color:"#1f2ce0",margin:"0 auto"}),w=!!c&&(0,x.jsx)(k.Z,{}),b=!o&&!c&&(0,x.jsxs)(X,{children:[(0,x.jsx)(G,{children:e("\u0417\u0430\u0442\u0440\u0430\u0447\u0435\u043d\u043d\u043e\u0435_\u0432\u0440\u0435\u043c\u044f")}),(0,x.jsx)(J,{children:ee(l,e("\u0441\u0435\u043a"),e("\u043c\u0438\u043d"))})]}),v=e=>{throw a(!1),p(!0),new Error(e)};return(0,i.useEffect)((()=>{(e=>new Promise((function(t,n){(0,f.jM)((0,f.iH)(m.Z,e),(e=>{t(e.val())}))})))(`${u}/users/user${t}/userInfo`).then(h).catch(v)}),[]),(0,x.jsxs)(x.Fragment,{children:[g," ",w," ",b]})},ne=d.ZP.article`
  box-sizing: border-box;
  background-color: #ffffff;
  display: flex;
  flex-direction: column;
...
`}}]);
//# sourceMappingURL=404.049c4873.chunk.js.map