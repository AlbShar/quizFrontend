...
`,Qe=e=>{let{setIsBtnNextDisabled:t,isBtnBackDisabled:n,setIsBtnBackDisabled:i}=e;const{t:s}=(0,de.$)("",{keyPrefix:"modules.testButtons.UI.btnBack"});let[a,l]=(0,r.useContext)(o.s$);const[d]=(0,r.useContext)(o.Hp),[u]=(0,r.useContext)(o.iT);return(0,c.jsxs)(_e,{id:"btnBack",onClick:e=>{l(a-1),t(!1),i(!0),(e=>{let{idUser:t,currentQuestionNumb:n,selectorAnswers:r,profession:i}=e;const o=`${i}/users/user${t}/answers/answer${n-1}`;let s="";try{(0,Se.jM)((0,Se.iH)(Pe.Z,o),(e=>{setTimeout((()=>{document.querySelectorAll(r).forEach((t=>{s=e.val().userAnswer,t.textContent===s&&(t.style.border="3px solid #5557FF",t.setAttribute("data-useranswer","true"))}))}),10)}),{onlyOnce:!0})}catch(a){if(!s)throw new Error(`The value of variable 'userAnswerDb' is ${s}. ${a}`);throw new Error(`Unknown mistake: ${a}`)}})({idUser:u,currentQuestionNumb:a,selectorAnswers:"#answersAll ul li",profession:d})},disabled:n,typeBtn:"back",children:[(0,c.jsx)("img",{src:He,alt:"\u041a\u043d\u043e\u043f\u043a\u0430 \u043d\u0430\u0437\u0430\u0434",style:{color:"red"}}),s("text")]})};const Ue=n.p+"static/media/rightArrow.68d8ba69dceb545c90c48c34f34567b7.svg",Oe=e=>{let{onClickButtonHandler:t,isBtnNextDisabled:n}=e;const{t:r}=(0,de.$)("",{keyPrefix:"modules.testButtons.UI.btnNext"});return(0,c.jsxs)(_e,{onClick:t,disabled:n,typeBtn:"next",children:[r("text"),(0,c.jsx)("img",{src:Ue,alt:"rightArrow"})]})},Le=a.ZP.article`
  box-sizing: border-box;
  display: flex;
  justify-content: space-between;
  align-items: center;
...
//# sourceMappingURL=530.c5035b51.chunk.js.map