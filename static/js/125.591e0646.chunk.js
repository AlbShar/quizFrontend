...
`;var P=n(184);const Z=e=>{let{isChooseProfession:t,setChooseProfession:n}=e;const[o]=(0,i.useContext)(d.Hp),[a,s]=(0,i.useContext)(d.Sc),[c,m]=(0,i.useState)(0),b=`${o}/questions`,Z=e=>{m(e)};(0,i.useEffect)((()=>{h(b,a).then(Z)}),[o]),(0,i.useEffect)((()=>{n(!1)}),[]);const{t:k}=(0,r.$)("",{keyPrefix:"modules.callToAction.components.infoTest"}),[y,C]=(0,i.useState)(!0),[$,T]=(0,i.useState)(0),[z,S]=(0,i.useState)(!1),I=[{text:` ${t?"~"+$:"0"} ${k("min")}`,srcIcon:g,alt:"icon of clock"},{text:`${t?$:"0"} ${k("questions")}`,srcIcon:u,alt:"icon of question in circle"},{text:`${t?c:"0"} ${k("block")}`,srcIcon:f,alt:" icon of bar chart "}].map(((e,t)=>(0,P.jsxs)(j,{children:[(0,P.jsx)(w,{src:e.srcIcon,alt:e.alt}),(0,P.jsx)("span",{style:{color:"var(--color-white)"},children:e.text})]},t+1))),N=y||z?null:I,_=y?(0,P.jsx)(x.$,{width:50,height:50,color:"#fcfdff",margin:"auto"}):null,F=z?(0,P.jsx)(p.B,{}):null,W=e=>{C(!1),T(e)},D=e=>{S(!0),C(!1),console.error(e)};return(0,i.useEffect)((()=>{if(o){const e=`${o}/questions`;(0,l.r)(e).then(W).catch(D)}else C(!1)}),[o]),(0,P.jsx)("nav",{children:(0,P.jsxs)(v,{children:[N," ",_," ",F]})})};var k=n(408),y=n(8285);var C=n(3008);const $=n.p+"static/media/arrowDownLarge.5cb9226dd89f16c2e62eb8a7b2afc8b7.svg",T=e=>{let{setChooseProfession:t}=e;const[,n]=(0,i.useContext)(d.Hp),{t:o}=(0,r.$)("",{keyPrefix:"modules.callToAction.UI.dropdownProfession"}),[a,s]=(0,i.useState)(""),l={"Frontend developer":"Frontend","Project Manager":"Manager"},x=Object.keys(l);return(0,P.jsx)(C.L,{typeFilter:"profession",selectedFilter:a||o("textBtn"),nameListItems:x,setFilter:e=>{(0,c.Z)("profession",l[e]),n(l[e]),s(e),t(!0)},srcArrowDown:$})},z=b.ZP.article`
  max-width: 100%;
  background-color: transparent;
  padding: 0;
  margin: 0 0 13px 0;
...
`,L=()=>{const{t:e}=(0,r.$)("",{keyPrefix:"components.aboutUs"});return(0,P.jsx)(H,{children:(0,P.jsx)(a.W,{children:(0,P.jsx)(E,{children:(0,P.jsxs)(o.ZP,{container:!0,columns:{xs:2,md:12,lg:12},children:[(0,P.jsx)(o.ZP,{item:!0,xs:2,md:6.2,lg:6.2,children:(0,P.jsx)(B,{children:e("mainTitle")})}),(0,P.jsxs)(o.ZP,{item:!0,xs:2,md:5.8,lg:5.8,children:[(0,P.jsxs)(A,{children:[e("text1")," "]}),(0,P.jsxs)(A,{children:[e("text2")," "]}),(0,P.jsxs)(A,{children:[e("text3"),(0,P.jsx)(U.x,{style:{color:"var(--color-purple)",font:"var(--font-text5)",fontWeight:700}}),e("text4")]})]}),(0,P.jsx)(R,{src:q,alt:"person_sitting"})]})})})})};const M=n.p+"static/media/img.762c12aa3293560ead8d0fe0c5ab66d1.svg";const O=n.p+"static/media/curve_line.41fc09e689b02c70523546b9e3d5eecf.svg",Y=b.ZP.h3`
  color: var(--color-black);
  font: var(--font-text10);
  text-align: center;
