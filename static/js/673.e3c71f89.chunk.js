...
`,Te=e=>{let{quizRef:t}=e;const{t:n}=(0,de.$)(),[i]=(0,r.useContext)(G.s$),[o]=(0,r.useContext)(G.Hp),[s]=(0,r.useContext)(G.Sc),[a,d]=(0,r.useState)(!0),[l,c]=(0,r.useState)(!1),[u,p]=(0,r.useState)(""),[x,h]=(0,r.useState)(0),m=a?(0,b.jsx)(le,{}):null,f=a||l?null:(0,b.jsxs)("section",{children:[(0,b.jsx)("article",{style:{backgroundColor:"#EEEEFF"},children:(0,b.jsx)(xe,{quizRef:t})}),(0,b.jsxs)(_e,{children:[(0,b.jsxs)("div",{children:[(0,b.jsxs)(Be,{id:"questionName",children:[n("\u0412\u043e\u043f\u0440\u043e\u0441")," ",i]}),(0,b.jsx)(Re,{id:"totalQuestionQuantity",tabIndex:0,children:`/ ${x}`}),(0,b.jsx)(Fe,{id:"themeQuestion",children:u})]}),(0,b.jsx)(qe,{})]})]}),g=l?(0,b.jsx)(J.Z,{}):null,w=e=>{const t={theme:null,totalQuestionNumber:null};e.forEach((e=>{"number"===typeof e.value?t.totalQuestionNumber=e.value:"string"===typeof e.value&&(t.theme=e.value)})),d(!1),p(`${t.theme}`),h(t.totalQuestionNumber);for(const n in t)if(!t[n])throw new Error(`Value of ${n} is ${t[n]} in object "items"`)},v=e=>{throw c(!0),d(!1),new Error(e)};return(0,r.useEffect)((()=>{const e=`${o}/questions/question${i}/${s}/theme`,t=`${o}/questions`;Promise.allSettled([ce(e),(0,ue.r)(t)]).then(w).catch(v)}),[i,s,o]),(0,b.jsxs)(b.Fragment,{children:[m,f,g]})};var De=n(9922);const Ie=n.p+"static/media/leftArrow.ffd35a492cc0b13d0f52b0e89016538e.svg",Me=K.ZP.button`
  box-sizing: border-box;
  display: flex;
  align-items: center;
  padding: 8px 18px;
...
`,Ve=e=>{let{isBtnNextDisabled:t,setIsBtnNextDisabled:n,userAnswer:i}=e;const[o,s]=(0,r.useContext)(G.s$),[a]=(0,r.useContext)(G.Sc),[d]=(0,r.useContext)(G.iT),[l]=(0,r.useContext)(G.Hp),{t:c}=(0,de.$)(),[u,p]=(0,r.useState)(0),[x,h]=(0,r.useState)(!0),m=(0,r.useCallback)((async()=>{const e=`${l}/questions`,t=await(0,ue.r)(e);p(t)}),[]);(0,r.useEffect)((()=>{m()}),[]);const f=e=>{s(o+1),Le({userAnswer:i,idUser:d,currentQuestionNumb:o,lang:a}),n(!0),h(!1)};return(0,b.jsxs)(We,{children:[(0,b.jsx)(Oe,{setIsBtnNextDisabled:n,isBtnBackDisabled:x,setIsBtnBackDisabled:h}),u===o?(0,b.jsx)(Ke.Z,{text:c("\u0417\u0430\u043a\u043e\u043d\u0447\u0438\u0442\u044c_\u0442\u0435\u0441\u0442"),pageTo:"/results",onClick:f,id:"btnFinish",isDisabledBtn:t}):(0,b.jsx)(Ue,{isBtnNextDisabled:t,onClickButtonHandler:f})]})},Ge=K.ZP.section`
...
`,Xe=()=>{const[e,t]=(0,r.useState)(1),n=(0,r.useRef)(null),[o,s]=(0,r.useState)(""),[a,d]=(0,r.useState)(!0);return(0,r.useEffect)((()=>{const e=e=>{e.preventDefault(),e.returnValue="\u0412\u044b \u0443\u0432\u0435\u0440\u0435\u043d\u044b, \u0447\u0442\u043e \u0445\u043e\u0442\u0438\u0442\u0435 \u043f\u043e\u043a\u0438\u043d\u0443\u0442\u044c \u044d\u0442\u0443 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443? \u0412\u0441\u0435 \u043d\u0435\u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u043d\u044b\u0435 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0431\u0443\u0434\u0443\u0442 \u043f\u043e\u0442\u0435\u0440\u044f\u043d\u044b."};return window.addEventListener("beforeunload",e),()=>{window.removeEventListener("beforeunload",e)}}),[]),(0,b.jsx)(De.P,{children:(0,b.jsx)(i.Z,{children:(0,b.jsx)(Ge,{ref:n,children:(0,b.jsxs)(G.s$.Provider,{value:[e,t],children:[(0,b.jsx)(Te,{quizRef:n}),(0,b.jsx)(ae,{}),(0,b.jsx)(te,{setIsBtnNextDisabled:d,setUserAnswer:s}),(0,b.jsx)(Ve,{setIsBtnNextDisabled:d,isBtnNextDisabled:a,userAnswer:o})]})})})})}},9922:(e,t,n)=>{n.d(t,{P:()=>r});const r=n(7691).ZP.main`
  flex: 1 1 auto;
  width: 100%;
...
//# sourceMappingURL=673.e3c71f89.chunk.js.map