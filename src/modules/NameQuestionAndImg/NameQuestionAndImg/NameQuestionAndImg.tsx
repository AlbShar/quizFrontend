...
const NameQuestionAndImg: FC = () => {
  ...
  useEffect(() => {
    ...
    insertImageQuiz({currentQuestionNumb, wrapperImgRef, imgRef, sourceMobImgRef, sourceTabletImgRef, sourceDesktopImgRef});
  });
  ...
  return (
    <StyledArticleQuestion>
      ...
      <source ref={sourceMobImgRef} type='image/png' media='(min-width:320px) and (max-width:486px)'></source>
      <source ref={sourceTabletImgRef} type='image/png' media='(min-width:487px) and (max-width:768px)'></source>
      <source ref={sourceDesktopImgRef} type='image/png' media='(min-width:769px)'></source>
